  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-white p-4 shadow-sm">
      ...
      <div className="flex mt-4 space-x-4">
        <button className="px-4 py-2 bg-blue-500 text-white rounded-md">Delete</button>
        <button className="px-4 py-2 bg-green-500 text-white rounded-md">Download</button>
